...
USER container_u
CMD ./mvnw clean package -Dmaven.test.skip=true && java -javaagent:./lib/spring-instrument-5.3.0.jar -javaagent:./lib/aspectjweaver-1.9.7.jar -jar ./target/mseuser.jar