package ca.bbenetti.msesuperuser.api.interceptor;

import ca.bbenetti.msesuperuser.context.SecurityContext;
...
public class SecurityInterceptor implements WebRequestInterceptor
{
	...
	public void preHandle(WebRequest request) throws Exception
	{
		...
		request.getHeaderNames().forEachRemaining((header) -> log.info( "==================\n" + header + "\n" + request.getHeader(header) + "\n"));
